...
export default function InviteTokenScreen() {
  ...
  useEffect(() => {
    setIsValidToken(claimInvite(inviteToken));
  ...
  return (
    <View style={styles.container}>
      ...
      {isValidToken ? (
        <>
          <Text style={styles.text}>Einladung erkannt. Du kannst jetzt direkt mit dem Quiz starten.</Text>
        ...
        <>
          <Text style={styles.error}>Der Einladungslink ist ungültig.</Text>
